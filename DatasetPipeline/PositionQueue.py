...
class PositionQueueRegistry:
    ...
    identificatore univoco per costruzione (stringa "{fonte}_{id}"),
    assegnato dal chiamante prima di enqueue (vedi docstring di modulo).
    Questa classe si occupa esclusivamente di:
